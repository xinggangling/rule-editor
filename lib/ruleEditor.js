...
var RuleEditor = function (_Component) {
  ...
  function RuleEditor(props) {
    ...
    _this.genTree = _this.genTree.bind(_this);
    return _this;
  }
    ...
    value: function componentDidMount() {
      ...
      d3.select('svg.ruleEditor').on('contextmenu', function (d) {
        ...
        _this2.setState({
          ...
          ctxmenuPosition: d3.mouse(_reactDom2.default.findDOMNode(_this2.refs.ruleEditor))
        });
      }).on('click', function () {
        _this2.setState({
          contextmenu: null
      ...
      var rootW = _reactDom2.default.findDOMNode(this.refs.ruleEditor).getBoundingClientRect().width;
      if (!rootW) {
        this.waitDisplay = setInterval(function () {
          var rootW = _reactDom2.default.findDOMNode(_this2.refs.ruleEditor).getBoundingClientRect().width;
          if (rootW) {
            _this2._resize();
            _this2._initRule();
    ...
    value: function update() {
      ...
      var nodes = nodesEnter.attr('class', 'node').merge(nodesUpdate).each(function (d) {
        ...
        _this4.setState({
          ...
          ctxmenuPosition: d3.mouse(_reactDom2.default.findDOMNode(_this4.refs.ruleEditor))
        });
      }).call(this.drag);
